...
class WorkerManagementServiceTest {
    ...
    @Autowired private WorkerManagementService workerManagementService;
    @MockBean private AccountForWorkerManagementPort accountForWorkerManagementPort;
    @MockBean private RosterForWorkerManagementPort rosterForWorkerManagementPort;
    ...
    public void permitWorkerToJoinSuccess() throws Exception {
        ...
        PermitWorkerToJoinReqDto permitWorkerToJoinReqDto =
                PermitWorkerToJoinReqDto.builder()
                        .waitingListId(1L)
                        .email("test@email.com")
                        .build();
        AccountForWorkerManagement accountForWorkerManagement =
                AccountForWorkerManagement.builder().id(2L).roles("EMPLOYER").build();
    ...
    public void permitDisagreedWorkerToJoin() throws Exception {
        ...
        Assertions.assertThrows(
                JoinWorkerDeniedException.class,
                () -> workerManagementService.permitWorkerToJoin(permitWorkerToJoinReqDto));
    }
    ...
    public void getWorkersBelongedToCompanySuccess() throws Exception {
        // given
        Long companyId = 1L;
        WorkerBelongedToCompanyReqDto workerBelongedToCompanyReqDto =
                WorkerBelongedToCompanyReqDto.builder().email("test@email.com").build();
        AccountForWorkerManagement accountForWorkerManagement =
                AccountForWorkerManagement.builder().id(2L).roles("EMPLOYER").build();
    ...
    public void getWorkersBelongedToCompanyByWorkerFailed() throws Exception {
        ...
        WorkerBelongedToCompanyReqDto workerBelongedToCompanyReqDto =
                WorkerBelongedToCompanyReqDto.builder().email("test@email.com").build();
        AccountForWorkerManagement accountForWorkerManagement =
                AccountForWorkerManagement.builder().id(2L).roles("EMPLOYEE").build();
    ...
    void exileWorker() throws Exception {
        // given
        AccountForWorkerManagement accountForWorkerManagement =
                AccountForWorkerManagement.builder().id(1L).roles("EMPLOYER").build();
        ExileWorkerReqDto exileWorkerReqDto =
                ExileWorkerReqDto.builder()
                        .email("test@email.com")
                        .accountId(1L)
                        .companyId(2L)
                        .build();
        RosterForWorkerManagement rosterForWorkerManagement =
                RosterForWorkerManagement.builder()
                        .accountId(1L)
                        .companyId(2L)
                        .baseStatus(BaseStatus.INACTIVE)
                        .build();
        ExileWorkerResDto exileWorkerResDto =
                ExileWorkerResDto.builder().message("해당 근무자가 업장에서 퇴장되었습니다.").build();
        ...
        Mockito.doNothing()
                .when(rosterForWorkerManagementPort)
                .exileWorker(rosterForWorkerManagement);

        // then
        Assertions.assertEquals(
                workerManagementService.exileWorker(exileWorkerReqDto).getMessage(),
                exileWorkerResDto.getMessage());
    }
    ...
    public void getWaitingWorkersSuccess() throws Exception {
        // given
        Long companyId = 10L;
        WaitingWorkerReqDto waitingWorkerReqDto =
                WaitingWorkerReqDto.builder().email("employer@email.com").build();
        AccountForWorkerManagement accountForWorkerManagement =
                AccountForWorkerManagement.builder().id(1L).roles("EMPLOYER").build();
        ...
        List<WaitingWorkerResDto> result =
        ...
        Assertions.assertAll(
                () ->
                        Assertions.assertEquals(
                                waitingWorkerResDtoList.get(0).getAccountId(),
                                result.get(0).getAccountId()),
                () ->
                        Assertions.assertEquals(
                                waitingWorkerResDtoList.get(0).getUserName(),
                                result.get(0).getUserName()),
                () ->
                        Assertions.assertEquals(
                                waitingWorkerResDtoList.get(0).getEmail(),
                                result.get(0).getEmail()),
                () ->
                        Assertions.assertEquals(
                                waitingWorkerResDtoList.get(0).getWaitingStatus(),
                                result.get(0).getWaitingStatus()),
                () ->
                        Assertions.assertEquals(
                                waitingWorkerResDtoList.get(1).getAccountId(),
                                result.get(1).getAccountId()),
                () ->
                        Assertions.assertEquals(
                                waitingWorkerResDtoList.get(1).getUserName(),
                                result.get(1).getUserName()),
                () ->
                        Assertions.assertEquals(
                                waitingWorkerResDtoList.get(1).getEmail(),
                                result.get(1).getEmail()),
                () ->
                        Assertions.assertEquals(
                                waitingWorkerResDtoList.get(1).getWaitingStatus(),
                                result.get(1).getWaitingStatus()),
                () ->
                        Assertions.assertEquals(
                                waitingWorkerResDtoList.get(2).getAccountId(),
                                result.get(2).getAccountId()),
                () ->
                        Assertions.assertEquals(
                                waitingWorkerResDtoList.get(2).getUserName(),
                                result.get(2).getUserName()),
                () ->
                        Assertions.assertEquals(
                                waitingWorkerResDtoList.get(2).getEmail(),
                                result.get(2).getEmail()),
                () ->
                        Assertions.assertEquals(
                                waitingWorkerResDtoList.get(2).getWaitingStatus(),
                                result.get(2).getWaitingStatus()));
    }
    ...
    public void getWorkerAttendanceRecordSuccess() throws Exception {
        ...
        GetWorkerAttendanceRecordReqDto getWorkerAttendanceRecordReqDto =
                GetWorkerAttendanceRecordReqDto.builder()
        ...
        GetWorkerAttendanceRecordResDto getWorkerAttendanceRecordResDto =
                GetWorkerAttendanceRecordResDto.builder()
                        .userName("홍길동")
        ...
        Mockito.when(accountForWorkerManagementPort.findAccountByEmail(anyString()))
                .thenReturn(accountForWorkerManagement);
        Mockito.when(
                        commuteRecordForWorkerManagementPort.getWorkerAttendanceRecord(
                                any(GetWorkerAttendanceRecordReqDto.class),
                                any(LocalDate.class),
                                any(LocalDate.class)))
                .thenReturn(getWorkerAttendanceRecordResDto);

        GetWorkerAttendanceRecordResDto result =
                workerManagementService.getWorkerAttendanceRecord(
                        getWorkerAttendanceRecordReqDto, 2023, 1);

        // then
        Assertions.assertAll(
                () ->
                        Assertions.assertEquals(
                                getWorkerAttendanceRecordResDto.getUserName(),
                                result.getUserName()),
                ...
                () ->
                        Assertions.assertEquals(
                                getWorkerAttendanceRecordResDto
                                        .getCommuteRecordResDtoList()
                                        .get(0)
                                        .getCommuteDate(),
                                result.getCommuteRecordResDtoList().get(0).getCommuteDate()),
                () ->
                        Assertions.assertEquals(
                                getWorkerAttendanceRecordResDto
                                        .getCommuteRecordResDtoList()
                                        .get(0)
                                        .getEnterTime(),
                                result.getCommuteRecordResDtoList().get(0).getEnterTime()),
                () ->
                        Assertions.assertEquals(
                                getWorkerAttendanceRecordResDto
                                        .getCommuteRecordResDtoList()
                                        .get(0)
                                        .getExitTime(),
                                result.getCommuteRecordResDtoList().get(0).getExitTime()),
                () ->
                        Assertions.assertEquals(
                                getWorkerAttendanceRecordResDto
                                        .getCommuteRecordResDtoList()
                                        .get(0)
                                        .isTardy(),
                                result.getCommuteRecordResDtoList().get(0).isTardy()),
                () ->
                        Assertions.assertEquals(
                                getWorkerAttendanceRecordResDto
                                        .getCommuteRecordResDtoList()
                                        .get(1)
                                        .getCommuteDate(),
                                result.getCommuteRecordResDtoList().get(1).getCommuteDate()),
                () ->
                        Assertions.assertEquals(
                                getWorkerAttendanceRecordResDto
                                        .getCommuteRecordResDtoList()
                                        .get(1)
                                        .getEnterTime(),
                                result.getCommuteRecordResDtoList().get(1).getEnterTime()),
                () ->
                        Assertions.assertEquals(
                                getWorkerAttendanceRecordResDto
                                        .getCommuteRecordResDtoList()
                                        .get(1)
                                        .getExitTime(),
                                result.getCommuteRecordResDtoList().get(1).getExitTime()),
                () ->
                        Assertions.assertEquals(
                                getWorkerAttendanceRecordResDto
                                        .getCommuteRecordResDtoList()
                                        .get(1)
                                        .isTardy(),
                                result.getCommuteRecordResDtoList().get(1).isTardy()),
                () ->
                        Assertions.assertEquals(
                                getWorkerAttendanceRecordResDto
                                        .getCommuteRecordResDtoList()
                                        .get(2)
                                        .getCommuteDate(),
                                result.getCommuteRecordResDtoList().get(2).getCommuteDate()),
                () ->
                        Assertions.assertEquals(
                                getWorkerAttendanceRecordResDto
                                        .getCommuteRecordResDtoList()
                                        .get(2)
                                        .getEnterTime(),
                                result.getCommuteRecordResDtoList().get(2).getEnterTime()),
                () ->
                        Assertions.assertEquals(
                                getWorkerAttendanceRecordResDto
                                        .getCommuteRecordResDtoList()
                                        .get(2)
                                        .getExitTime(),
                                result.getCommuteRecordResDtoList().get(2).getExitTime()),
                () ->
                        Assertions.assertEquals(
                                getWorkerAttendanceRecordResDto
                                        .getCommuteRecordResDtoList()
                                        .get(2)
                                        .isTardy(),
                                result.getCommuteRecordResDtoList().get(2).isTardy()),
                () ->
                        Assertions.assertEquals(
                                absentRecordDtoList.get(0).getAbsentDate(),
                                result.getAbsentRecordResDtoList().get(0).getAbsentDate()),
                () ->
                        Assertions.assertEquals(
                                absentRecordDtoList.get(1).getAbsentDate(),
                                result.getAbsentRecordResDtoList().get(1).getAbsentDate()));
    }

    @Test
    @DisplayName("고용주 - 특정 근무자 상세조회 - 실패" + "지원되지 않는 날짜를 조회하는 경우")
        ...
        Assertions.assertAll(
                () ->
                        Assertions.assertThrows(
                                ...
                                () ->
                                        workerManagementService.getWorkerAttendanceRecord(
                                                getWorkerAttendanceRecordReqDto, 1999, 1)),
                () ->
                        Assertions.assertThrows(
                                UnsupportedDateException.class,
                                () ->
                                        workerManagementService.getWorkerAttendanceRecord(
                                                getWorkerAttendanceRecordReqDto, 2024, 1)));
    }
    ...
    public void getAllReplaceSuccess() throws Exception {
        ...
        GetAllReplaceRecordReqDto getAllReplaceRecordReqDto =
                GetAllReplaceRecordReqDto.builder().email("test@email.com").companyId(1L).build();
        AccountForWorkerManagement accountForWorkerManagement =
        ...
        Mockito.when(accountForWorkerManagementPort.findAccountByEmail(anyString()))
                .thenReturn(accountForWorkerManagement);
        Mockito.when(
                        replaceForWorkerManagementPort.getAllReplaceRecord(
                                any(GetAllReplaceRecordReqDto.class)))
                .thenReturn(getAllReplaceRecordResDtoList);
        List<GetAllReplaceRecordResDto> result =
        ...
        Assertions.assertAll(
                () ->
                        Assertions.assertEquals(
                                getAllReplaceRecordResDtoList.get(0).getUserName(),
                                result.get(0).getUserName()),
                () ->
                        Assertions.assertEquals(
                                getAllReplaceRecordResDtoList.get(0).getReplaceWorkerName(),
                                result.get(0).getReplaceWorkerName()),
                () ->
                        Assertions.assertEquals(
                                getAllReplaceRecordResDtoList.get(0).getReplaceDate(),
                                result.get(0).getReplaceDate()),
                () ->
                        Assertions.assertEquals(
                                getAllReplaceRecordResDtoList.get(0).getEnterTime(),
                                result.get(0).getEnterTime()),
                () ->
                        Assertions.assertEquals(
                                getAllReplaceRecordResDtoList.get(0).getExitTime(),
                                result.get(0).getExitTime()),
                () ->
                        Assertions.assertEquals(
                                getAllReplaceRecordResDtoList.get(1).getUserName(),
                                result.get(1).getUserName()),
                () ->
                        Assertions.assertEquals(
                                getAllReplaceRecordResDtoList.get(1).getReplaceWorkerName(),
                                result.get(1).getReplaceWorkerName()),
                () ->
                        Assertions.assertEquals(
                                getAllReplaceRecordResDtoList.get(1).getReplaceDate(),
                                result.get(1).getReplaceDate()),
                () ->
                        Assertions.assertEquals(
                                getAllReplaceRecordResDtoList.get(1).getEnterTime(),
                                result.get(1).getEnterTime()),
                () ->
                        Assertions.assertEquals(
                                getAllReplaceRecordResDtoList.get(1).getExitTime(),
                                result.get(1).getExitTime()),
                () ->
                        Assertions.assertEquals(
                                getAllReplaceRecordResDtoList.get(2).getUserName(),
                                result.get(2).getUserName()),
                () ->
                        Assertions.assertEquals(
                                getAllReplaceRecordResDtoList.get(2).getReplaceWorkerName(),
                                result.get(2).getReplaceWorkerName()),
                () ->
                        Assertions.assertEquals(
                                getAllReplaceRecordResDtoList.get(2).getReplaceDate(),
                                result.get(2).getReplaceDate()),
                () ->
                        Assertions.assertEquals(
                                getAllReplaceRecordResDtoList.get(2).getEnterTime(),
    ...
    private List<CommuteRecordDto> setDefaultCommuteRecordDtoList() {
        ...
        CommuteRecordDto commuteRecordDto1 =
                CommuteRecordDto.builder()
                        ...
                        .tardy(true)
                        .build();
        CommuteRecordDto commuteRecordDto2 =
                CommuteRecordDto.builder()
                        ...
                        .tardy(false)
                        .build();
        CommuteRecordDto commuteRecordDto3 =
                CommuteRecordDto.builder()
    ...
    private List<AbsentRecordDto> setDefaultAbsentRecordDtoList() {
        ...
        AbsentRecordDto absentRecordDto1 =
                AbsentRecordDto.builder().absentDate(LocalDate.of(2023, 1, 1)).build();
        AbsentRecordDto absentRecordDto2 =
                AbsentRecordDto.builder().absentDate(LocalDate.of(2023, 1, 10)).build();
    ...
    private AccountForWorkerManagement setDefaultEmployerAccountForWorkerManagement() {
        return AccountForWorkerManagement.builder().id(1L).roles("EMPLOYER").build();
    }
    ...
    private List<GetAllReplaceRecordResDto> setDefaultReplaceList() {
        ...
        GetAllReplaceRecordResDto getAllReplaceRecordResDto1 =
                GetAllReplaceRecordResDto.builder()
                        ...
                        .build();
        GetAllReplaceRecordResDto getAllReplaceRecordResDto2 =
                GetAllReplaceRecordResDto.builder()
                        .userName("test2")
                        ...
                        .exitTime(LocalDateTime.now())
                        .build();
        GetAllReplaceRecordResDto getAllReplaceRecordResDto3 =
                GetAllReplaceRecordResDto.builder()
                        .userName("test3")
