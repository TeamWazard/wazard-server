...
class CompanyServiceTest {
    ...
    @MockBean private CompanyPort companyPort;
    @MockBean private AccountForCompanyPort accountForCompanyPort;
    @MockBean private RosterForCompanyPort rosterForCompanyPort;
    ...
    public void updateCompanyInfoSuccess() throws Exception {
        ...
        UpdateCompanyInfoReqDto updateCompanyInfoReqDto =
                UpdateCompanyInfoReqDto.builder()
                        .companyId(1L)
                        .email("test@email.com")
        ...
        Mockito.when(accountForCompanyPort.findAccountByEmail(anyString()))
                .thenReturn(accountForCompany);
        Mockito.when(companyPort.findCompanyById(anyLong())).thenReturn(company);
        ...
        Assertions.assertAll(
                () ->
                        Assertions.assertEquals(
                                ...
                                updateCompanyInfoReqDto.getCompanyName()),
                () ->
                        Assertions.assertEquals(
                                company.getCompanyInfo().getCompanyAddress(),
                                updateCompanyInfoReqDto.getCompanyAddress()),
                () ->
                        Assertions.assertEquals(
                                company.getCompanyInfo().getCompanyContact(),
                                updateCompanyInfoReqDto.getCompanyContact()),
                () ->
                        Assertions.assertEquals(
                                company.getCompanyInfo().getSalaryDate(),
                                updateCompanyInfoReqDto.getSalaryDate()));
    }
    ...
    public void deleteCompanySuccess() throws Exception {
        // given
        DeleteCompanyReqDto deleteCompanyReqDto =
                DeleteCompanyReqDto.builder().email("test@email.com").companyId(1L).build();
        AccountForCompany accountForCompany = setDefaultEmployerAccountForManagement();
    ...
    public void getOwnedCompanyList() throws Exception {
        // given
        GetOwnedCompanyReqDto getOwnedCompanyReqDto =
                GetOwnedCompanyReqDto.builder().email("test@gmail.com").build();
        AccountForCompany accountForCompany = setDefaultEmployerAccountForManagement();
        ...
        List<GetOwnedCompanyResDto> result =
                companyService.getOwnedCompanyList(1L, getOwnedCompanyReqDto);
        ...
        Assertions.assertAll(
                () ->
                        Assertions.assertEquals(
                                ...
                                getOwnedCompanyResDtoList.get(0).getCompanyName()),
                () ->
                        Assertions.assertEquals(
                                result.get(1).getCompanyName(),
                                getOwnedCompanyResDtoList.get(1).getCompanyName()),
                () ->
                        Assertions.assertEquals(
                                result.get(2).getCompanyName(),
                                getOwnedCompanyResDtoList.get(2).getCompanyName()));
    }
    ...
    void getBelongedCompany() throws Exception {
        // given
        GetBelongedCompanyReqDto getBelongedCompanyReqDto =
                GetBelongedCompanyReqDto.builder().email("test@email.com").build();
        AccountForCompany accountForCompany = setDefaultEmployeeAccountForManagement();
        List<GetBelongedCompanyResDto> getBelongedCompanyResDtoList =
                setDefaultBelongedCompanyList();
        ...
        List<GetBelongedCompanyResDto> result =
                companyService.getBelongedCompanyList(1L, getBelongedCompanyReqDto);

        // then
        Assertions.assertAll(
                () ->
                        Assertions.assertEquals(
                                getBelongedCompanyResDtoList.get(0).getCompanyName(),
                                result.get(0).getCompanyName()),
                () ->
                        Assertions.assertEquals(
                                getBelongedCompanyResDtoList.get(1).getCompanyName(),
                                result.get(1).getCompanyName()),
                () ->
                        Assertions.assertEquals(
                                getBelongedCompanyResDtoList.get(2).getCompanyName(),
                                result.get(2).getCompanyName()));
    }

    private AccountForCompany setDefaultEmployerAccountForManagement() {
        return AccountForCompany.builder().id(1L).roles("EMPLOYER").build();
    }

    private AccountForCompany setDefaultEmployeeAccountForManagement() {
        return AccountForCompany.builder().id(1L).roles("EMPLOYEE").build();
    }
    ...
    private List<GetOwnedCompanyResDto> setDefaultOwnedCompanyList() {
        ...
        GetOwnedCompanyResDto getOwnedCompanyResDto1 =
                GetOwnedCompanyResDto.builder()
                        ...
                        .build();
        GetOwnedCompanyResDto getOwnedCompanyResDto2 =
                GetOwnedCompanyResDto.builder()
                        ...
                        .build();
        GetOwnedCompanyResDto getOwnedCompanyResDto3 =
                GetOwnedCompanyResDto.builder()
    ...
    private List<GetBelongedCompanyResDto> setDefaultBelongedCompanyList() {
        ...
        GetBelongedCompanyResDto getBelongedCompanyResDto1 =
                GetBelongedCompanyResDto.builder()
                        ...
                        .logoImageUrl("www.test1.com")
                        .build();
        GetBelongedCompanyResDto getBelongedCompanyResDto2 =
                GetBelongedCompanyResDto.builder()
                        .companyName("companyName2")
                        .companyAddress("companyAddress2")
                        .companyContact("02-222-2222")
                        ...
                        .logoImageUrl("www.test2.com")
                        .build();
        GetBelongedCompanyResDto getBelongedCompanyResDto3 =
                GetBelongedCompanyResDto.builder()
                        .companyName("companyName3")
                        .companyAddress("companyAddress3")
                        .companyContact("02-333-3333")
