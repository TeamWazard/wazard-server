...
class MyPageController {
    ...
    public ResponseEntity<GetMyAttitudeScoreResDto> getMyAttitudeScore(@PathVariable Long accountId, @Valid @RequestBody GetMyAttitudeScoreReqDto getMyAttitudeScoreReqDto) {
        GetMyAttitudeScoreResDto getMyAttitudeScoreResDto = myPageService.getMyAttitudeScore(getMyAttitudeScoreReqDto);
